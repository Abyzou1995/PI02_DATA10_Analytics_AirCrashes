...
st.markdown("<h1 style='text-align: center; color: black;'>KPI: ACCIDENT FATALITY RATE</h1>",
            unsafe_allow_html=True)
st.markdown("***")
st.markdown("This KPI describes the rate of number of accidents with at least one fatality over the total number of accidents that occurred.")
st.markdown("<h3 style='text-align: center; color: black;'>Rate=N° Accidents With Fatalities/N° Accidents</h3>",
            unsafe_allow_html=True)
